...
cd ../MC_analysis
save(sprintf('MTD_%s.mat', MCName), 'MTD')
save(sprintf('WTD_%s.mat', MCName), 'WTD')
save(sprintf('NMaxG_%s.mat', MCName), 'NMaxG')
save(sprintf('NAvgG_%s.mat', MCName), 'NavgG')
