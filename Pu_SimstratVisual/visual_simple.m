...
% xticks(linspace(datenum(2001,01,01), datenum(2016,12,31), 16))
xticks([datenum(time_datetime(1)):365: datenum(time_datetime(end))])
datetick('x', 'yyyy', 'keepticks')

% datetick('x', 'mmm yyyy', 'keeplimits')

% ax = gca(); 
% ax.XTick = linspace(datetime(2000,09,25),datetime(2016,12,31), 20); 
xtickangle(30)
ylim([0 200])
ylabel("Depth [m]")
% title("log(Kz)")
