function [temp_weakest_difference, datetime_weakest_difference] = indicator2(path2file)
...
%  ../Indicators folder.
%
% indicator2 file is modified to output Temperature weakest difference and
% the time when that difference occur 7/5/2022
%
